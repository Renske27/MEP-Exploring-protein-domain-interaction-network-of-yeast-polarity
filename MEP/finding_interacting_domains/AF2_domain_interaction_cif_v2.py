...
def find_interacting_domains(input_dir, output_dir, json_file, plDDT):
    ...
    for dirpath, dirnames, filenames in os.walk(input_dir):
        for filename in filenames:
            if filename.endswith("_ranked_0.cif"): #_model_0.cif
                try:
                    # Extract protein names from the filename
                    protein1, protein2 = filename.split('_')[2:4]
                    ...
                    for atom1, atom2 in contacts:
                        if atom1 in atoms1 and atom2 in atoms2:
                            ...
                            if plddt1 < plDDT or plddt2 < plDDT:
                                continue  # Skip this interaction if either score is below 50
...
# output_dir = "C:/Users/rensk/PycharmProjects/MEP_codefiles/MEP/data/list2_data/contacts2"
# json_file = "C:/Users/rensk/PycharmProjects/MEP_codefiles/MEP/data/list2_data/domains_protein_list2.json"

# Paths AF2
data_dir = "E:/MEP_Renske/alphafold2/"
output_dir_plDDT50 = "C:/Users/rensk/PycharmProjects/MEP_codefiles/MEP/data/list2_data/contactsAF2_plDDT50"
#output_dir_plDDT70 = "C:/Users/rensk/PycharmProjects/MEP_codefiles/MEP/data/list2_data/contactsAF2_plDDT70"
json_file = "C:/Users/rensk/PycharmProjects/MEP_codefiles/MEP/data/list2_data/domains_protein_list2.json"
